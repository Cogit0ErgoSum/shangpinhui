<template>
  <div class="clearfix selector">
    ...
    <div class="type-wrap" v-for="(attr, index) in attrsList" :key="attr.attrId">
      ...
      <div class="fl value">
        <ul class="type-list">
          <li v-for="(value, index) in attr.attrValueList" :key="attr.attrValueList.index" @click="attrInfo(attr, value)">
            <a>{{ value }}</a>
          </li>
        </ul>
      </div>
...
import { mapGetters } from 'vuex';
  ...
  export default {
    name: 'SearchSelector',
    computed: {
      ...mapGetters('search',{trademarkList: 'trademarkList'}),
      ...mapGetters('search',{attrsList: 'attrsList'})
    },
    methods: {
