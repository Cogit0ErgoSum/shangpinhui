          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a href="javascript:" class="mins" @click="skuName>1?skuNum--:skuName=1">-</a>
              </div>
              <div class="add">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters('detail', {categoryView: 'categoryView'}),

      ...mapGetters('detail', {skuInfo: 'skuInfo'}),

      ...mapGetters('detail', {spuSaleAttrList: 'spuSaleAttrList'}),
